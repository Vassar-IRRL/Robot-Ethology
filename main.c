...
bool is_front_bump()
{
	return (front_bump_left_value == 0 || front_bump_center_value == 0 || front_bump_right_value == 0); // return true if one of the front bump values is 1, otherwise false
}
/******************************************************/
bool is_back_bump()
{
...
void escape_front()
{
	...
	else if(front_bump_center_value == 0)
	{
		drive(-0.5, 0.5, 0.5);
	}
